...
DATA_JS="".join(f"const {k}={json.dumps(data[v],ensure_ascii=False)};\n" for k,v in [
 ...
 ("PROJ","PROJ"),
 ("ALLURES","ALLURES"),("ALLURES_COURSE","ALLURES_COURSE"),("MONTHLY","MONTHLY"),("SAISON2026","SAISON2026"),("ACWR_DATA","ACWR_DATA"),("RECORDS_PERF","RECORDS_PERF"),("JOURNAL","JOURNAL"),("REWINDS","REWINDS"),("ZONES_FC","ZONES_FC"),("SEANCES_BY_WEEK","SBW"),("MAJ","MAJ"),("HEATMAP","HEATMAP"),("DOSSIERS","DOSSIERS"),("PALMARES","PALMARES")])
