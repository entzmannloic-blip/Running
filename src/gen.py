...
PALMARES=[
  ...
  {"nom":"Run In Lyon 10km","alias":"Run In Lyon 10k","date":"2022-10-02","lieu":"Lyon · France","type":"route","distance":10,"dplus":None,"dminus":None,"temps":"53:58","allure":"5:24","classement_gen":4900,"classement_cat":None,"total_finishers":None,"cat":None,"fc_moy":None,"fc_max":None,"cal":None,"chaussures":None,"meteo":None,"statut":"termine","strava_id":None,"accent":"#f97316","bilan":"10km sur les berges de Lyon en 53:58 · allure 5:24/km. #4900 au général sur une très grande course de masse. <strong>Référence pour calibrer la progression :</strong> objectif sub-50 min en 2026-2027."},
  {"nom":"SaintéLyon — Relais Équipe","alias":"SaintéLyon relay","date":"2022-12-03","lieu":"Yssingeaux → Lyon","type":"trail_nuit","distance":22.77,"dplus":459,"dminus":900,"temps":"2:27:00","allure":"6:28","classement_gen":None,"classement_cat":None,"total_finishers":None,"cat":None,"fc_moy":None,"fc_max":None,"cal":None,"chaussures":None,"meteo":"Nuit · ~4°C · hiver","statut":"termine","strava_id":None,"accent":"#8b5cf6","bilan":"Relais #4 de l'équipe SaintéLyon. <strong>Référence directe pour la préparation SaintExpress 2026 :</strong> segment km 27-45 du parcours. Allure 6:28/km de nuit avec 459m D+. Validation que le segment final est gérable après km 27 parcourus."},
  {"nom":"Trail des Hautes Chaumes","alias":"Hautes Chaumes","date":"2022-05-08","lieu":"Roche · France","type":"trail","distance":6,"dplus":None,"dminus":None,"temps":"46:29","allure":"7:45","classement_gen":44,"classement_cat":None,"total_finishers":None,"cat":"SE","fc_moy":None,"fc_max":None,"cal":None,"chaussures":None,"meteo":None,"statut":"termine","strava_id":None,"accent":"#14b8a6","bilan":"Court trail local ~6km · allure 7:45/km. <strong>#44 au général</strong> — excellent classement sur une épreuve technique. Catégorie SE à l'époque."},
  {"nom":"Harmonie Mutuelle Semi de Paris","alias":"Semi de Paris","date":"2022-03-06","lieu":"Paris · France","type":"semi","distance":21.1,"dplus":None,"dminus":None,"temps":"1:53:21","allure":"5:22","classement_gen":27259,"classement_cat":None,"total_finishers":None,"cat":None,"fc_moy":None,"fc_max":None,"cal":None,"chaussures":None,"meteo":None,"statut":"termine","strava_id":None,"accent":"#3b82f6","bilan":"Premier grand semi-marathon officiel. 1:53:21 chrono réel · 5:22/km. #27259 au général dans l'une des plus grandes courses de France. <strong>Référence de départ :</strong> objectif 1:44 au Semi de Lyon 4 oct. 2026 = −9 min en 4 ans de progression."}
]
_j.dump({"PHASES":PHASES,"COUL":COUL,"SEMAINES":SEMAINES,"SBW":SEANCES_BY_WEEK,"GEAR":GEAR,"RACES":RACES,
  ...
  "HIST":_hist["HIST"],"POLAR":_hist["POLAR"],"ALLURES":ALLURES,"ALLURES_COURSE":ALLURES_COURSE,"ZONES_FC":ZONES_FC,"MONTHLY":MONTHLY,"SAISON2026":SAISON2026,"ACWR_DATA":ACWR_DATA,"RECORDS_PERF":RECORDS_PERF,"JOURNAL":JOURNAL,"REWINDS":REWINDS,"MAJ":"19 juin 2026","HEATMAP":HEATMAP,"DOSSIERS":DOSSIERS,"PALMARES":PALMARES,"CHANGELOG":CHANGELOG},open('/tmp/data.json','w'),ensure_ascii=False)
print("OK")
