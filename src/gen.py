...
for n,ss in WEEKS.items():
    ...
    if n==32:
        ...
        arr[4]["realise"]={"statut":"fait","km":10.09,"temps":"1h00","allure":"5:58/km","fc_moy":132,"fc_max":149,"cadence":176,"elevation_gain":43,"rpe_ressenti":3,
