...
for n,ss in WEEKS.items():
    ...
    if n==26:
        ...
        arr[1]["realise"]={"statut":"fait","km":10.66,"temps":"1h02","allure":"5:47/km","fc_moy":148,"fc_max":161,"rpe_ressenti":5,"commentaire":"10,66 km en 1h02 · départ 8h00 · FC 148/161 · cadence 87 · D+ 20 m · Novablast 5 J · canicule (4 jours à ~40 \u00b0C, nuits >30 \u00b0C). Mardi et mercredi sautés (chaleur). Footing dans le tunnel sans accélérer ; sensation de fatigue mais score qui grimpe sans accélération physiologique réelle.","pr":0,"ach":0,"pr_detail":[],"revue":"<strong>Sortir aujourd'hui, c'était la bonne décision.</strong> Après 4 jours de canicule (~40 \u00b0C le jour, nuits qui ne descendent pas sous 30 \u00b0C) et 2 séances sautées mardi-mercredi, ce footing de 10,7 km à 5:47/km remet le moteur en route sans creuser la fatigue. À J-10 de la Déraille, c'est exactement le bon dosage.<br><br><strong>Ta sensation était juste — les données la confirment à 100 %.</strong> Tu as senti que « le score accélérait » sans avoir l'impression d'accélérer physiologiquement, avec ce km à 5:17. C'est exactement ce qui s'est passé : sur la 2e moitié, ta FC a dérivé de 145 vers 153 bpm <strong>pour une allure qui ne montait pas vraiment</strong>. À FC constante 153 (~80 % FCmax), tu aurais couru ce km autour de 5:25-5:30 par temps frais ; le passage à 5:17 est une portion favorable, pas un gain de forme. <strong>C'est de la dérive cardiaque pure, signature de la chaleur + fatigue accumulée.</strong> Ton corps payait déjà cher : FC haute pour un effort qui ne le justifiait pas.<br><br><strong>Le RPE élevé pour l'effort réel produit, c'est le thermomètre.</strong> Il te dit que la canicule te coûte 10-15 % de surcharge cardiaque à allure égale. Tu n'as pas forcé, tu as écouté — foulée nette (cadence 87), aucune accélération volontaire. Gestion parfaite.<br><br><strong>La suite :</strong> on reste sur cette ligne jusqu'à la Déraille. La spécifique vallonnée reste la séance qui compte — à caler tôt le matin (5h-6h30) sur un créneau supportable, sinon on l'allège. Samedi repos. Arriver frais > tout le reste."}
