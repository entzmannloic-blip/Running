...
for n,ss in WEEKS.items():
    ...
    if n==27:
        ...
        arr[1]["realise"]={"statut":"partiel","km":6.0,"temps":"~35min","allure":"~5:10/km","fc_moy":0,"fc_max":0,"rpe_ressenti":6,"commentaire":"Tempo 2×15min interrompu · souci gastrique en cours de séance · ~6 km courus avant arrêt. Activité non visible sur Strava. J-4 avant Déraille.","pr":0,"ach":0,"pr_detail":[],"revue":"<strong>Arrêté par le corps, pas par la tête.</strong> Un problème gastrique en plein tempo à J-4, c'est frustrant — et c'est aussi un signal à écouter. Tu t'es arrêté au bon moment : continuer un effort soutenu avec des troubles digestifs aurait coûté plus en récupération que les kilomètres non courus. La gestion de l'effort commence par là.<br><br><strong>Pour la Déraille :</strong> surveille ta nutrition vendredi-samedi (rien de nouveau, rien de gras, glucides simples). Ce type de réaction peut venir d'un écart alimentaire ou de la chaleur persistante. Si ça passe bien ces deux jours, c'est derrière toi."}
        arr[2]["date"]="2026-07-02"
        arr[2]["chaussure"]="Clifton 10"
        arr[2]["realise"]={"statut":"fait","km":10.55,"temps":"1h01","allure":"5:41/km","fc_moy":148,"fc_max":170,"rpe_ressenti":4,"commentaire":"10,55 km en 1h01 · matin 9h25 · FC 148/170 · cadence 87 · D+ 46 m · RE 96 · 827 kcal · Clifton 10 · 0 PR · berges Rhône-Confluence. J-3 Déraille.","pr":0,"ach":0,"pr_detail":[],"revue":"<strong>La sortie parfaite à J-3.</strong> 10,5 km à 5:41/km, FC 148 stable en Z2 — zéro accélération, zéro PR. Splits entre 5:29 et 5:58/km, le corps tourne en automatique. C'est ce signe-là qu'on cherche avant une course.<br><br><strong>Note chaussures :</strong> Clifton 10 à 1114 km — ne pas embarquer dimanche. <strong>Cascadia 19 pour la Déraille, point final.</strong><br><br><strong>La suite :</strong> repos vendredi-samedi, hydratation, glucides simples, sommeil maximal. Tu es prêt."}
        SEANCES_BY_WEEK[str(n)]=arr
