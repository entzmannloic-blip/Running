...
for n,ss in WEEKS.items():
    ...
    if n==27:
        ...
        arr[0]["realise"]={"statut":"fait","km":6.55,"temps":"35min","allure":"5:22/km","fc_moy":149,"fc_max":172,"rpe_ressenti":6,"commentaire":"6,55 km en 35 min \u00b7 matin 9h31 \u00b7 FC 149/172 \u00b7 cadence 87 \u00b7 D+ 27 m \u00b7 Magic Speed 4 \u00b7 structure naturelle : 4 km EF (FC 131-145) + 3 km tempo (FC 159-168, ~4:48-5:00/km).","pr":3,"ach":3,"pr_detail":[],"revue":"<strong>Pas juste un petit run rapide \u2014 un EF + tempo structur\u00e9.</strong> Km 1-4 en Z2 (FC 131-145), puis km 5-7 gliss\u00e9s vers le seuil (FC 159-168, ~4:50/km) sans forcer. Magic Speed 4 bien choisi. FC max 172 = seuil touch\u00e9 sans d\u00e9border. <strong>Les jambes r\u00e9pondent \u00e0 J-5 \u2014 c'est tout ce qu'on voulait savoir.</strong>"}
